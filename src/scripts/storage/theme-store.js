...
const BUILTIN_THEMES = Object.freeze([
  ...
  },
  {
    ...
    tokens: {
      ...
      bubble: {
        user: '#2563eb',
        assistant: 'rgba(15, 23, 42, 0.98)',
        assistantAlt: 'rgba(30, 41, 59, 0.96)',
        meta: 'rgba(15, 23, 42, 0.72)',
      },
      shadow: {
        sm: '0 1px 4px rgba(2, 6, 23, 0.42)',
        md: '0 16px 38px rgba(2, 6, 23, 0.42)',
        bubble: '0 12px 24px rgba(2, 6, 23, 0.32)',
