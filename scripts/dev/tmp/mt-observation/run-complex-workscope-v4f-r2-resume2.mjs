...
const batch = 'complex-workscope-v4f-r2-resume2-0730';
const defaultOutput = resolve(
  'scripts/dev/tmp/mt-observation/results-complex-workscope-v4f-r2-resume2-0730.jsonl',
);

tasks.push({
  id: 'complex-workscope-v4f-r2-resume2-0730-001',
  batch,
  category: 'natural_user_resume_interrupted_setup',
  prompt: [
    '继续这条已中断的女仆任务。',
    'runId: run:c7a87b5b-144c-4f2b-807f-0baff883ca28',
  ].join('\n'),
  expectedFeatures: [],
  expectedTools: [],
  expectedAnyTools: [],
